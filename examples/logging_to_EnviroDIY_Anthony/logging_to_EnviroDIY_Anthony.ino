...
MODIFIED BY Anthony Aufdenkampe for "Anthonys_Desk" site
...
const char *LOGGERNAME = "Mayfly 160065";
const char *FILE_NAME = "Mayfly 160065";
const char *DATA_HEADER = "JSON Formatted Data";

// Register your site and get these tokens from data.envirodiy.org
const char *REGISTRATION_TOKEN = "675dadcb-47d6-4ff3-9196-7d5960fb9dda";
const char *SAMPLING_FEATURE = "b5125363-1f8a-41f6-b72a-5f925f99c977";
const int TIME_ZONE = -6;
const char *ONBOARD_TEMPERATURE_UUID = "f11a0dae-158e-4b75-8b40-eba3b5ec5ecb";
const char *ONBOARD_BATTERY_UUID = "fc7c6811-cdc8-4de5-bcfc-24b4d53a8e29";
